...
class SoundExchange
{
     ...
     *
     */
    public static function convert($original, $converted, $rate = '128k', $bitrate = 128, $lame = FALSE)
    {
        if ($lame)
        {
        ...
        {
            $cmd = "sox -b $bitrate $original $converted rate $rate";
        }
